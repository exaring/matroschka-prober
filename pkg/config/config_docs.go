...
func init() {
	...
	ClassDoc.Fields[0].Description = ""
	ClassDoc.Fields[0].Comments[encoder.LineComment] = ""
	ClassDoc.Fields[1].Name = "tos"
	ClassDoc.Fields[1].Type = "uint8"
	ClassDoc.Fields[1].Note = ""
	ClassDoc.Fields[1].Description = ""
	ClassDoc.Fields[1].Comments[encoder.LineComment] = ""
